...
/**
 * check99 - check the file_to was created or can be written too
 * @check: check if it is true of false
 * @file: file to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
 *
...
/**
 * main -copy of the content of a file to another file.
 * @argc: number of arguments is passed
